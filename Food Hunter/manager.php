...
<?php
    ...
    function handleBackRequest() {
        ...
        $url="https://www.students.cs.ubc.ca/~zfzhao/h1.php";
    ...
    function handlePurchaseRequest() {
        ...
        $url="https://www.students.cs.ubc.ca/~zfzhao/purchase.php?".$curr;
        echo "<script LANGUAGE=\"Javascript\">";
        echo "location.href='$url'";
        echo "</script>";
    }
    ...
    function handleDesignRequest() {
        ...
        if(strcmp(substr($rest,0,strlen("Haililao Hotpot")),"Haidilao Hotpot")==0){
            $url="https://www.students.cs.ubc.ca/~zfzhao/design.php?".$curr."+Haidilao";
            echo "<script LANGUAGE=\"Javascript\">";
            echo "location.href='$url'";
            echo "</script>";}
        else if(strcmp(substr($rest,0,strlen("Miss Korea BBQ")),"Miss Korea BBQ")==0){
            $url="https://www.students.cs.ubc.ca/~zfzhao/design.php?".$curr."+MissKorea";
            echo "<script LANGUAGE=\"Javascript\">";
            echo "location.href='$url'";
            echo "</script>";}
        else if(strcmp(substr($rest,0,strlen("Pacific Poke")),"Pacific Poke")==0){
            $url="https://www.students.cs.ubc.ca/~zfzhao/design.php?".$curr."+PacificPoke";
            echo "<script LANGUAGE=\"Javascript\">";
            echo "location.href='$url'";
            echo "</script>";}
        else if(strcmp(substr($rest,0,strlen("Cactus Club Cafe")),"Cactus Club Cafe")==0){
            $url="https://www.students.cs.ubc.ca/~zfzhao/design.php?".$curr."+CactusClubCafe";
            echo "<script LANGUAGE=\"Javascript\">";
            echo "location.href='$url'";
            echo "</script>";}
        else if(strcmp(substr($rest,0,strlen("Church Chicken")),"Church Chicken")==0){
            $url="https://www.students.cs.ubc.ca/~zfzhao/design.php?".$curr."+ChurchChicken";
            echo "<script LANGUAGE=\"Javascript\">";
            echo "location.href='$url'";
            echo "</script>";}
    }
