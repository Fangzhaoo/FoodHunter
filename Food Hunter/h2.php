...
<?php
    ...
    function connectToDB() {
        ...
        $db_conn = OCILogon("ora_zfzhao", "a78528494", "dbhost.students.cs.ubc.ca:1522/stu");
    ...
    if(isset($_POST['daccount'])){
        ...
        $url="https://www.students.cs.ubc.ca/~zfzhao/delete.php?".$curr;
    ...
    if(isset($_POST['change'])){
        if(connectToDB()){
            $arg = $_SERVER["QUERY_STRING"]."<br>";
            $curr = substr($arg,0,strlen($arg)-4);
            $url="https://www.students.cs.ubc.ca/~zfzhao/reset.php?".$curr;
            echo "<script LANGUAGE=\"Javascript\">";
            echo "location.href='$url'";
            echo "</script>";
            }
    ...
    if(isset($_POST['place'])){
        if(connectToDB()){
            ...
            $r=$_POST['R'];
            if($r=="Haidilao"){
                $url="https://www.students.cs.ubc.ca/~zfzhao/placeOrder.php?".$curr."+Haidilao";
                echo "<script LANGUAGE=\"Javascript\">";
                echo "location.href='$url'";
                echo "</script>";}
            if($r=="MissKorea"){
                $url="https://www.students.cs.ubc.ca/~zfzhao/placeOrder.php?".$curr."+MissKorea";
                echo "<script LANGUAGE=\"Javascript\">";
                echo "location.href='$url'";
                echo "</script>";}
            if($r=="PacificPoke"){
                $url="https://www.students.cs.ubc.ca/~zfzhao/placeOrder.php?".$curr."+PacificPoke";
                echo "<script LANGUAGE=\"Javascript\">";
                echo "location.href='$url'";
                echo "</script>";}
            if($r=="CactusClubCafe"){
                $url="https://www.students.cs.ubc.ca/~zfzhao/placeOrder.php?".$curr."+CactusClubCafe";
                echo "<script LANGUAGE=\"Javascript\">";
                echo "location.href='$url'";
                echo "</script>";}
            if($r=="ChurchChicken"){
                $url="https://www.students.cs.ubc.ca/~zfzhao/placeOrder.php?".$curr."+ChurchChicken";
                echo "<script LANGUAGE=\"Javascript\">";
                echo "location.href='$url'";
                echo "</script>";}
            }
    ...
    if(isset($_POST['logout'])){
        $url="https://www.students.cs.ubc.ca/~zfzhao/h.php";
        echo "<script language=\"JavaScript\">";
    ...
    if(isset($_POST['profile'])){
        $arg = $_SERVER["QUERY_STRING"]."<br>";
        $curr = substr($arg,0,strlen($arg)-4);
        $url="https://www.students.cs.ubc.ca/~zfzhao/user.php?".$curr;
        echo "<script language=\"JavaScript\">";
        echo "location.href='$url'";
        echo "</script>";
    }
