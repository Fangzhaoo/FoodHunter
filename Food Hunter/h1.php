...
<?php
    ...
    function handleSelectRequest() {
        ...
        if($c==" Customer"){
            ...
            if (($row = oci_fetch_row($result)) != false) {
                ...
                $url="https://www.students.cs.ubc.ca/~zfzhao/h2.php?".$a;
        ...
        if (($row = oci_fetch_row($result)) != false) {
            ...
            if (($row1 = oci_fetch_row($result1)) != false) {
                $url="https://www.students.cs.ubc.ca/~zfzhao/manager.php?".$a;
                echo "<script LANGUAGE=\"Javascript\">";
                echo "location.href='$url'";
                echo "</script>";
                OCICommit($db_conn);
                ...
                $url="https://www.students.cs.ubc.ca/~zfzhao/employee.php?".$a;
                echo "<script LANGUAGE=\"Javascript\">";
                echo "location.href='$url'";
                echo "</script>";
                OCICommit($db_conn);
    ...
    function handleSignRequest() {
        ...
        $url="https://www.students.cs.ubc.ca/~zfzhao/signup.php";
        echo "<script LANGUAGE=\"Javascript\">";
        echo "location.href='$url'";
        echo "</script>";
    }
